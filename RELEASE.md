...
* Enabled overriding nested parameters with `params` in CLI, i.e. `kedro run --params="model.model_tuning.booster=gbtree"` is updating parameters to`{"model": {"model_tuning": {"booster": "gbtree"}}}`.
