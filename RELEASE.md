...
* Deprecating the "Thanks for supporting contributions" section on Release notes to simplify the contribution
  process, Kedro 0.17.6 will be the last release that supports this section
