...
> _Note:_ If you're using the `ipython` [extension](https://kedro.readthedocs.io/en/stable/11_tools_integration/02_ipython.html#ipython-extension) instead, you will not encounter this problem.
...
## Migration guide from Kedro 0.16._ to 0.17._
...
> _Note_: As always, if you hit any problems, please check out our documentation:
>
...
- Added a set of registration hooks, as the new way of registering library components with a Kedro project:
  _ `register_pipelines()`, to replace `_get_pipelines()`
  _ `register_config_loader()`, to replace `_create_config_loader()` \* `register_catalog()`, to replace `_create_catalog()`
...
### Migration guide from Kedro 0.15._ to 0.16._
