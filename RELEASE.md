...
* All dataset classes will be removed from the core Kedro repository (`kedro.extras.datasets`). Instead, you will need to install and import them from the [`kedro-datasets`](https://github.com/kedro-org/kedro-plugins/tree/main/kedro-datasets) package.
