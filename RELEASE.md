...
| --------------------------- | ---------------------------------------------------- | --------------------------------- |
| `networkx.GMLDataSet`       | Works with networkx graph XML                        | `kedro.extras.datasets.networkx` |
| `networkx.GPickleDataSet`   | Works with networkx graph pickle                     | `kedro.extras.datasets.networkx` |
