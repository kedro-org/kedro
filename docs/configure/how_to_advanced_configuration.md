...
This guide covers advanced configuration techniques for Kedro projects. For an understanding of how configuration works, see the [configuration concepts guide](configuration_explanation.md).
...
For the full list of features, see [Configuration concepts](configuration_explanation.md) and this advanced configuration guide.
