...
The `kedro-dagster` plugin by [Guillaume Tauzin](https://github.com/gtauzin) at [stateful-y](https://stateful-y.io) enables you to translate your Kedro project to Dagster. Consult the [GitHub repository for `kedro-dagster`](https://github.com/stateful-y/kedro-dagster) for further details, take a look at the [documentation](https://kedro-dagster.readthedocs.io/), or explore the GitHub repository for the associated example repository [`kedro-dagster-example`](https://github.com/stateful-y/kedro-dagster).
