...
[Kedro-Viz doc](https://docs.kedro.org/projects/kedro-viz/en/stable/) is a tool that enables you to visualise your Kedro pipeline and metrics generated from your data engineering and data science experiments. It is a standalone web application that runs in a browser and can run on a local machine or in a Databricks notebook.
