...
Kedro defines Hook specifications for particular execution points where users can inject additional behaviour. [kedro.framework.hooks][] provides the following Hook specifications:
