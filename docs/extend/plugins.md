...
- [kedro-dagster](https://github.com/stateful-y/kedro-dagster), by [Guillaume Tauzin](https://github.com/gtauzin) at [stateful-y](https://stateful-y.io), enables translating a Kedro project to [Dagster](https://dagster.io/). It comes with an example project to get you started in the [kedro-dagster-example repo](https://github.com/stateful-y/kedro-dagster-example). You can find more information in the [kedro-dagster documentation](https://kedro-dagster.readthedocs.io/).
