...
[Kedro provides different built-in datasets](https://docs.kedro.org/projects/kedro-datasets/en/latest/) for numerous file types and file systems, so you don’t have to write the logic for reading/writing data.
