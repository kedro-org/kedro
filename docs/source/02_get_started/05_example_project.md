...
-   `catalog.yml` - [Configures the Data Catalog](../05_data/01_data_catalog.html#using-the-data-catalog-within-kedro-configuration) with the file paths and load/save configuration required for different datasets
