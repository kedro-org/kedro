...
Within your [virtual environment](../02_getting_started/03_new_project.md#install-project-specific-dependencies) and your project's root directory, you can install project dependencies by running:
