...
* If `version.save` is `None` then a new save version string will be generated by calling `kedro.io.core.generate_current_version()`, otherwise a string representing exact save version must be provided.
