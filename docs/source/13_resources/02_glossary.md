...
[Further information about the Data Catalog](../05_data/01_data_catalog.md)
...
[Introduction to Kedro](../01_introduction/01_introduction.md)
...
[Further information about `KedroSession`](../04_kedro_project_setup/03_session.md)
...
[Further information from the Kedro-Viz repository](https://github.com/quantumblacklabs/kedro-viz) and [Kedro tutorial documentation](../03_tutorial/05_visualise_pipeline.md)
...
Kedro-Viz makes it easy to [visualise these data processing stages](../03_tutorial/05_visualise_pipeline.md#visualise-layers) by adding a `layer` attribute to the datasets in the Data Catalog.
...
[Further information about modular pipelines](../06_nodes_and_pipelines/03_modular_pipelines.md)
...
[Further information about nodes](../06_nodes_and_pipelines/01_nodes.md)
...
[Further information about pipelines](../06_nodes_and_pipelines/02_pipeline_introduction.md)
...
[Further information about pipeline slicing](../06_nodes_and_pipelines/06_slice_a_pipeline.md)
...
[Further information about runners](../06_nodes_and_pipelines/05_run_a_pipeline.md)
...
[Further information about Kedro starters](../02_get_started/06_starters.md)
