...
This is why Kedro provides a built-in {class}` `PartitionedDataset` <kedro-datasets:kedro_datasets.partitions.PartitionedDataset>` with the following features:
