...
1. [Initialise an Airflow project with Astro](https://docs.astronomer.io/learn/custom-airflow-ui-docs-tutorial#step-1-create-an-astro-project). Let's call it `kedro-airflow-iris`
