...
- [Package a Kedro project](../tutorial/package_a_project.md#package-a-kedro-project)
- [Run a packaged project](../tutorial/package_a_project.md#run-a-packaged-project)
