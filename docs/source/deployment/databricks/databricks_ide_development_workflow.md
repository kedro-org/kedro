...
[Refer to the Databricks documentation](https://docs.databricks.com/en/dev-tools/cli/authentication) for a complete guide on how to authenticate your CLI. The key steps are:
