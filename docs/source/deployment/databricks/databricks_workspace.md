...
```{note}
If you are using [Databricks Repos](https://docs.databricks.com/repos/index.html) to run a Kedro project then you should not use file-based-logging. This prevents Kedro from attempting to write to the read-only file system.
```
