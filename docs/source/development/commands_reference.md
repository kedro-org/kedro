...
| `kedro run --node=<node_name1>,<node_name2>`                       | Run only nodes with specified names. <br /> Multiple instances allowed.                                                                                                                                                                                 |
...
| `kedro run --tag=<tag_name1>,<tag_name2>`                          | Run only nodes which have any of these tags attached. <br /> Multiple instances allowed.                                                                                                                                                                |
| `kedro run --load-version=<dataset_name>:YYYY-MM-DDThh.mm.ss.sssZ` | Specify a particular dataset version (timestamp) for loading. <br /> Multiple instances allowed.                                                                                                                                                        |
...
| `kedro run --conf-source=<path_to_config_directory or archive>`    | Specify a new source directory or tar.gz/zip file for configuration files                                                                                                                                                                               |
