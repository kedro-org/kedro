...
For new and intermediate Kedro users, there's a comprehensive section on [visualising Kedro projects using Kedro-Viz](../visualisation/kedro-viz_visualisation.md) and [working with Kedro and Jupyter notebooks](../notebooks_and_ipython/index.md).
