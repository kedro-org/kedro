...
This command automatically opens a browser tab to serve the visualisation at `http://127.0.0.1:4141/`. Explore the visualisation at leisure, and consult the {doc}`visualisation documentation <kedro-viz:kedro-viz_visualisation>` for more detail.
