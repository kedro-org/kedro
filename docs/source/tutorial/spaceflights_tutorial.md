...
```{note}
If you are unfamiliar with a typical ``git`` workflow, you can follow one of the most popular, known as `Gitflow <https://www.atlassian.com/git/tutorials/comparing-workflows/gitflow-workflow>`_.
```
