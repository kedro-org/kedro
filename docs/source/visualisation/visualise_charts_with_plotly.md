...
```text
kedro-datasets[pandas.CSVDataSet, pandas.ExcelDataSet, pandas.ParquetDataSet]~=1.1.0
kedro-datasets[plotly.PlotlyDataSet, plotly.JSONDataSet]~=1.1.0
```
...
```bash
kedro-datasets[matplotlib.MatplotlibWriter]~=1.1.0
seaborn~=0.12.1
```
