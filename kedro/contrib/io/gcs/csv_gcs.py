...
class CSVGCSDataSet(AbstractVersionedDataSet):
    """``CSVGCSDataSet`` loads and saves data to a file in gcs. It uses google-cloud-storage
    ...
    def __init__(
        ...
        """
        _gcs = storage.Client(credentials=credentials, project=project)
        super().__init__(
        ...
        self._gcs = _gcs
        self._bucket = _gcs.get_bucket(bucket_name)
    ...
    def _exists(self) -> bool:
        ...
        blob = storage.Blob(str(PurePosixPath(load_path)), self._bucket)
        return blob.exists(self._gcs)
