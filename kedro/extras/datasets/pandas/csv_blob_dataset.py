...
""" ``CSVBlobDataSet`` implementation to access CSV files directly from
...
class CSVBlobDataSet(AbstractVersionedDataSet):
    ...
    def __init__(
        ...
        blob_to_text_args: Dict[str, Any] = None,
        blob_from_text_args: Dict[str, Any] = None,
        ...
        Args:
            filepath: Path to an Azure Blob of a CSV file.
        ...
        self._blob_to_text_args = deepcopy(blob_to_text_args) or {}
        self._blob_from_text_args = deepcopy(blob_from_text_args) or {}
