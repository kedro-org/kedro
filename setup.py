...
extras_require = {
    ...
    "docs": [
        ...
        "myst-parser~=1.0.0",
        "Jinja2<3.1.0",
        "kedro-datasets[all,pandas-deltatabledataset]@git+https://github.com/kedro-org/kedro-plugins@bugfix/deltatabledataset-indent-fix#subdirectory=kedro-datasets",
    ],
