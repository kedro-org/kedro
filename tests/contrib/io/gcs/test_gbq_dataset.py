...
from kedro.contrib.io.gcs.gbq_dataset import GBQTableDataSet
...
class TestGBQDataSet:
    ...
    def test_load_missing_file(self, gbq_dataset, mocker):
        ...
        mocked_read_gbq = mocker.patch("kedro.contrib.io.gcs.gbq_dataset.pd.read_gbq")
    ...
    def test_credentials_propagation(self, mocker):
        ...
        mocked_credentials = mocker.patch(
            "kedro.contrib.io.gcs.gbq_dataset.Credentials", return_value=credentials_obj
        )
        mocked_bigquery = mocker.patch("kedro.contrib.io.gcs.gbq_dataset.bigquery")
