...
class TestMatplotlibLocalWriter:
    def test_save_simgle_image(self, tmp_path):
        ...
        plot_writer = MatplotlibLocalWriter(filepath=str(expected_filepath))
    ...
    def test_save_dict_images(self, tmp_path):
        ...
        plot_writer = MatplotlibLocalWriter(filepath=str(tmp_path / "dict_images"))
        assert not plot_writer.exists()
        plot_writer.save(plots)
        assert plot_writer.exists()
    ...
    def test_load_fail(self, tmp_path):
        plot_writer = MatplotlibLocalWriter(filepath=str(tmp_path / "some_path"))

        pattern = r"Loading not supported for `MatplotlibLocalWriter`"
    ...
    def test_exists(self, tmp_path):
        ...
        plot_writer = MatplotlibLocalWriter(filepath=str(tmp_path / "some_image.png"))
        assert not plot_writer.exists()
