...
class TestMicropkgPackageCommand:
    ...
    def test_package_micropkg(
        ...
        result = CliRunner().invoke(
            fake_project_cli,
            ["micropkg", "package", PIPELINE_NAME] + options,
            obj=fake_metadata,
        )
    ...
    def test_micropkg_package_to_destination(
        ...
        result = CliRunner().invoke(
            fake_project_cli,
            ["micropkg", "package", PIPELINE_NAME, "--destination", str(destination)],
            obj=fake_metadata,
        )
    ...
    def test_package_micropkg_bad_alias(
        ...
        result = CliRunner().invoke(
            fake_project_cli,
            ["micropkg", "package", PIPELINE_NAME, "--alias", bad_alias],
        )
    ...
    def test_package_non_existing_pipeline_dir(
        ...
        result = CliRunner().invoke(
            fake_project_cli, ["micropkg", "package", "non_existing"], obj=fake_metadata
        )
    ...
    def test_package_empty_pipeline_dir(
        ...
        result = CliRunner().invoke(
            fake_project_cli, ["micropkg", "package", "empty_dir"], obj=fake_metadata
        )
        assert result.exit_code == 1
    ...
    def test_package_modular_pipeline_with_nested_parameters(
        ...
        result = CliRunner().invoke(
            fake_project_cli, ["micropkg", "package", "retail"], obj=fake_metadata
        )
    ...
    def test_package_micropkg_with_deep_nested_parameters(
        self, fake_repo_path, fake_project_cli, fake_metadata
    ):
        CliRunner().invoke(
            fake_project_cli, ["pipeline", "create", "retail"], obj=fake_metadata
    ...
    def test_micropkg_package_version(
        ...
        result = CliRunner().invoke(
            fake_project_cli, ["micropkg", "package", _pipeline_name], obj=fake_metadata
        )
        assert result.exit_code == 0
