"""Integration tests for the inspection public API against a mock Kedro project.

The fixture ``mock_project`` creates a minimal project that mirrors the
structure of the spaceflights-pandas starter.
"""
